...
| Asset                         | Location |
| ----------------------------- | -------- |
| Final LoRA adapter            | 🤗 [`gnzrg25/Qwen2VL-2B-AIGID-LoRA`](https://huggingface.co/gnzrg25/Qwen2VL-2B-AIGID-LoRA) |
| Merged FP16 model (optional)  | 🤗 [`gnzrg25/Qwen2VL-2B-AIGID-merged`](https://huggingface.co/gnzrg25/Qwen2VL-2B-AIGID-merged) |
| Training dataset (JSONL)      | 🤗 [`gnzrg25/LPCVC2026-Track3-Finetune-64k`](https://huggingface.co/datasets/gnzrg25/LPCVC2026-Track3-Finetune-64k) |
| Submission binary             | 📦 [GitHub Release `v1.0-lpcvc2026-winner`](https://github.com/Ganzooo/LPCVC2026-Track3-OptimAI-1st/releases) |
...
```bash
huggingface-cli download gnzrg25/LPCVC2026-Track3-Finetune-64k \
